...
export const useQuery = {
	...
	Demo: (args: QueryArgsWithInput<DemoInput>) =>
		hooks.useQueryWithInput<DemoInput, DemoResponseData, Role>(WunderGraphContext, {
			operationName: "Demo",
			requiresAuthentication: false,
		})(args),
...
export const useLiveQuery = {
	...
	Demo: (args: SubscriptionArgsWithInput<DemoInput>) =>
		hooks.useSubscriptionWithInput<DemoInput, DemoResponseData, Role>(WunderGraphContext, {
			operationName: "Demo",
			isLiveQuery: true,
			requiresAuthentication: false,
		})(args),
